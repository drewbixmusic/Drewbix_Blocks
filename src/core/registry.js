...
export const MOD = {
  ...
  rand_forest: {
    ...
    cfg: {
      ...
      max_trees:              { t: 'sel',   opts: ['25', '50', '100', '200', '400', '800'], d: '100', l: 'Max Trees (per fold)' },
      ...
      holdout_sets:           { t: 'text',  d: '', l: '[K-fold] Holdout Set Modifiers (comma-separated, e.g. 3,8)' },
      validation_ratio:       { t: 'sel',   opts: ['0.20', '0.25', '0.33', '0.50'], d: '0.25', l: '[K-fold] Validation Ratio (determines k folds)' },
      key_modifier_sep:       { t: 'text',  d: '_', l: '[K-fold] Modifier Separator (char that separates base key from set number)' },
      fallback_x_field:       { t: 'dynfield', d: 't_rel', l: '[K-fold] Fallback X Field (when no modifiers)' },
      fallback_bands:         { t: 'sel',   opts: ['5', '8', '10', '15', '20'], d: '10', l: '[K-fold] Fallback Band Count' },
      pilot_forest:           { t: 'bool',  d: true, l: '[K-fold] Pilot Forest + Permutation Importance' },
      validation_weighting:   { t: 'bool',  d: true, l: '[K-fold] Weight Trees by Validation R²' },
      honest_rf:              { t: 'bool',  d: false, l: '[K-fold] Honest RF (Wager-Athey split-sample)' },
      overfitting_warn_threshold: { t: 'sel', opts: ['5%', '10%', '20%', '33%', '50%', 'Off'], d: '20%', l: '[K-fold] Overfitting Warning Threshold' },
    },
  },
