...
export const MOD = {
  ...
  mv_regression: {
    ...
    cfg: {
      ...
      key_modifier_sep: { t: 'text',  d: '_', l: '[Ensemble] Modifier Separator (auto-detects sets e.g. _1…_10)' },
      fallback_x_field: { t: 'dynfield', d: 't_rel', l: '[Ensemble] Fallback X Field (when no set modifiers)' },
      fallback_bands:   { t: 'sel',   opts: ['5', '8', '10', '15', '20'], d: '10', l: '[Ensemble] Fallback Band Count' },
    },
  },
  rand_forest: {
    ...
    cfg: {
      ...
      test_pct:               { t: 'sel',   opts: ['10%', '15%', '20%', '25%', '30%'], d: '20%', l: '[Standard] Test Split %' },
      key_modifier_sep:       { t: 'text',  d: '_', l: '[K-fold] Modifier Separator (default _ → strip _1,_2… suffix)' },
      fallback_x_field:       { t: 'dynfield', d: 't_rel', l: '[K-fold] Fallback X Field (used when no set modifiers detected)' },
